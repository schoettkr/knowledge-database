...
BLOG_AUTHOR = "schoettkr"  # (translatable)
BLOG_TITLE = "Knowledge Database"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://schoettkr.github.io/knowledge-database/"
...
# is in the manual.
COMMENT_SYSTEM_ID = "knowledge-database"
